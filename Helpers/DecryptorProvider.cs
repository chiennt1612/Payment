...
namespace Payment.Helpers
{
    ...
    {
        private static string passPhrase = "VTVCap-Vtalent";
        ...
        public static string Decrypt ( string a)
        {
            ...
            if (!(a == null || a == ""))
            {
                try
                {
                    s = (new RijndaelEnhanced(passPhrase, initVector)).Decrypt(a);
                    //_logger.Information($"Giai ma {a}: {s}");
                }
                catch (Exception ex)
                {
                    s = a;
                    //_logger.Error($"Giai ma {a}: {ex.ToString()}");
                }
            }
        ...
        public static string Encrypt(string a)
        {
            ...
            if (!(a == null || a == ""))
            {
                try
                {
                    s = (new RijndaelEnhanced(passPhrase, initVector)).Encrypt(a);
                    //_logger.Information($"Ma hoa {a}: {s}");
                }
                catch (Exception ex)
                {
                    s = a;
                    //_logger.Error($"Ma hoa {a}: {ex.ToString()}");
                }
            }
